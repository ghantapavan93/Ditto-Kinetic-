      ...
      <div className="relative flex h-full flex-col justify-between px-gutter py-[clamp(1.25rem,4vh,2.25rem)]">
        ...
        <section className="max-w-[32rem]">
          <AnimatePresence mode="popLayout">
            ...
            >
              ...
              <p className="mt-3 max-w-[36ch] font-editorial text-[0.78rem] lowercase leading-relaxed tracking-wide text-paper/62">
        ...
        <footer className="grid gap-4">
          ...
          <div className="flex flex-wrap items-baseline gap-x-8 gap-y-2 border-t border-paper/12 pt-3">
            <p className="font-editorial text-[0.74rem] lowercase tracking-wide text-paper/62">
              <span className="text-paper/55">best night — </span>
              {weather.best.name}, {weather.best.openings}
            </p>
            <p className="font-editorial text-[0.74rem] lowercase tracking-wide text-paper/62">
              <span className="text-paper/55">looks busy, is not — </span>
              {weather.emptiestFullNight.name}, {Math.round(weather.emptiestFullNight.density * 100)}% usable
            </p>
            <p className="font-editorial text-[0.74rem] lowercase tracking-wide text-acid">
              <span className="text-paper/55">drop day — </span>
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-2">
            ...
            <span className="max-w-[46ch] font-editorial text-[0.7rem] lowercase leading-relaxed tracking-wide text-paper/55">
