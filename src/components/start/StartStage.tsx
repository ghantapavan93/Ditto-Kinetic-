      ...
      <div className="relative mx-auto flex min-h-screen max-w-[54rem] flex-col gap-9 px-gutter py-[clamp(1.5rem,5vh,3rem)]">
        ...
        <section className="max-w-[40rem]">
          ...
          <p className="mt-3 max-w-[46ch] font-voice text-[clamp(1.05rem,2.4vw,1.35rem)] leading-snug text-paper/70">
            there are {EVIDENCE.routes} surfaces and you should not open {EVIDENCE.routes} surfaces.
            pick the one that&rsquo;s yours. the shortest is{' '}
            <Link
              href={shortest.route}
            ...
            >
              ...
              >
                <div>
                  ...
                  <p className="mt-1.5 max-w-[52ch] font-editorial text-[0.95rem] leading-snug text-paper/30">
                    doesn&rsquo;t: {way.doesNot}
                  </p>
                </div>
                <p className="shrink-0 font-mono text-[0.68rem] uppercase tracking-[0.16em] text-tungsten/70 transition-colors group-hover:text-tungsten sm:text-right">
                  {way.route}
        ...
        <section className="border-t border-paper/[0.09] pt-5">
          ...
          <p className="mt-3 max-w-[52ch] font-voice text-[1.05rem] leading-snug text-paper/45">
