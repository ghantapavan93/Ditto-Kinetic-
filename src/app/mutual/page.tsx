...
export const metadata: Metadata = {
  ...
  description:
    'The engine scored every room once and called it the pair\u2019s. Nine of its eleven terms are things two people feel separately. Scored from both sides, an introduction is only as good as the person who wants it less.',
};

/**
 * The two-sided correction.
 *
 * Not a new dimension and not a new engine -- the same eleven terms, weighted
